    ...
    <section className="w-full bg-surface-bright py-section-gap" id="portfolio">
      <div className="max-w-[1440px] mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
          ...
          <Link to="/products/tomato-powder" className="flex flex-col h-full group cursor-pointer">
            <div className="relative w-full aspect-[4/5] overflow-hidden bg-surface-container mb-6 rounded-sm shadow-sm group-hover:shadow-xl transition-shadow duration-500">
              <img
          ...
          <div className="md:col-span-7 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-gutter gap-y-12 content-start">
            
            {/* Item 1: Moringa */}
            <RevealOnScroll delay={200}>
            <Link to="/products/moringa-powder" className="flex flex-col group cursor-pointer">
              <div className="w-full aspect-square overflow-hidden bg-surface-container mb-4 rounded-sm shadow-sm group-hover:shadow-lg group-hover:-translate-y-1 transition-all duration-500">
                <img
            ...
            <Link
              to="/products"
              className="flex flex-col group cursor-pointer justify-center items-center border border-outline/20 aspect-square hover:bg-surface-container-low transition-all duration-300 rounded-sm hover:-translate-y-1 hover:shadow-md"
            >

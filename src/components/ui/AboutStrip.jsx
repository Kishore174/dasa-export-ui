      ...
      <div className="max-w-[1440px] mx-auto px-margin-mobile md:px-margin-desktop">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-center">
          ...
          <div className="md:col-span-6 relative pb-8 md:pb-0">
            ...
            <div className="relative w-full aspect-[4/3] rounded-sm overflow-hidden shadow-sm bg-slate-100 border border-slate-200/60 group">
              <img
            ...
            <div className="absolute bottom-0 right-4 md:bottom-6 md:-right-6 bg-white border border-slate-200 p-6 md:p-8 shadow-xl max-w-[240px] md:max-w-[290px] z-10 transition-transform duration-500 hover:-translate-y-2 hover:shadow-2xl">
          ...
          <div className="md:col-span-6 flex flex-col justify-center space-y-6 pt-4 md:pt-0 md:pl-4">
            ...
            <div className="pt-2">
              <Link
                to="/about"
                className="inline-flex items-center gap-2 font-label-md text-sm font-semibold text-[#F15A24] border-b border-[#F15A24]/40 hover:border-[#F15A24] transition-all pb-1 group"
              >
